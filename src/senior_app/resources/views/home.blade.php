...
@section('delivering')
    ...
    @if (count($taxi_status) > 0)
        <header style="background-color: #faf7c8">
            <div class="container py-3">
                <div class="row">
                    <div class="col d-flex align-items-center">
                        <h5 class="text-danger">タクシー</h5>
                    </div>
                    <div class="col">
                        <h5 class="text-body">まもなくお迎えにあがります</h5>
                    </div>
                </div>
            </div>
        </header>
    ...
    @foreach ($deliveries as $delivery)
        @if ($delivery->status === '配達中')
            <header style="background-color: #cceeff">
                <div class="container py-3">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h5 class="text-danger">配達中</h5>
                        </div>
                        <div class="col">
                            <h5 class="text-body">{{ $delivery->shop_name }}</h5>
                        </div>
                    </div>
                </div>
            </header>
    ...
    @foreach ($items as $item)
        @if ($item->status === '配達中')
            @php
                $item_name = mb_substr($item->item_name, 0, 40) . '...';
            @endphp
            <header style="background-color: #ffe6f0">
                <div class="container py-3">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h5 class="text-danger">配達中</h5>
                        ...
                        <div class="col">
                            <h5 class="text-body">{{ $item_name }}</h5>
                        </div>
                    </div>
                </div>
            </header>
                            ...
                            @foreach ($posts as $post)
                                <tr>
                                    <td class="text-white"><img
                                            src="{{ asset('images/icon/home_secondary_32px.png') }}">　<strong>{{ $post->content }}</strong>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            @foreach ($deliveries as $delivery)
                                <tr>
                                    <td class="text-white"><img
                                            src="{{ asset('images/icon/home_secondary_32px.png') }}">　<strong>{{ $delivery['shop_name'] }}</strong>
                                    </td>
                                </tr>
                            @endforeach
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            @foreach ($items as $item)
                                <tr>
                                    <td class="text-white"><img
                                            src="{{ asset('images/icon/home_secondary_32px.png') }}">　<strong>{{ $item['item_name'] }}</strong>
                                    </td>
                                </tr>
                            @endforeach
